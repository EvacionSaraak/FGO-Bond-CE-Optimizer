...
const state={servants:[],ces:[],selectedServants:Array(SLOT_COUNT).fill(null),selectedServantBond15:Array(SLOT_COUNT).fill(false),selectedServantBondHidden:Array(SLOT_COUNT).fill(false),selectedCEs:Array(SLOT_COUNT).fill(null),selectedCEOwned:Array(SLOT_COUNT).fill(false),activeServantSlot:null,activeCESlot:null,servantSearch:"",ceSearch:"",servantSidebarLoading:true,ceSidebarLoading:true,servantSidebarLoadingProgress:10,ceSidebarLoadingProgress:5,servantOptimizationEnabled:false,servantSidebarPage:1,servantSidebarPageSize:SIDEBAR_PAGE_SIZE_OPTIONS[0],ceSidebarPage:1,ceSidebarPageSize:SIDEBAR_PAGE_SIZE_OPTIONS[0],recommendations:[],dataMode:"remote"};
const dom={};
